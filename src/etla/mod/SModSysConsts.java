...
public abstract class SModSysConsts {
    ...
    public static final int AS_PAY_MET_CSH = 2;
    public static final int AS_PAY_MET_CHK = 3;
    public static final int AS_PAY_MET_TRN = 5;
    public static final int AS_PAY_MET_DBT = 6;
